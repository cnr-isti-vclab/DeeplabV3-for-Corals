dictScripps={"Corallimorph/Urchin": [255, 0, 10],
  "Sea Star": [113, 39, 43],
  "Sea Cucumber": [55, 5, 8],
  "Cavularia": [158, 11, 15],
  "Zooanthid": [121, 0, 0],
  ...
  "Montipora_capitata": [119, 255, 189],
...
dictMoorea={"Millepora": [0, 255, 255],
    "Astrea_spp": [113, 39, 43],
    "Acropora_corymbose_dead": [238, 145, 147],
    "Pocillopora": [240, 110, 170],
    "Pocillopora_dead": [55, 5, 8],
    "Acropora_table_dead": [102, 45, 145],
    "Acropora_branching_dead": [146, 39, 143],
    "Acropora_branching": [158, 0, 93],
    "Acropora_corymbose": [133, 96, 168],
    "Pavona": [23, 146, 144],
    "Leptastrea": [255, 245, 104],
    "Leptoseris": [130, 123, 0],
    "Fungia_single": [242, 101, 34],
    "Porites_rus": [0, 87, 130],
    "Porites_lobata": [109, 207, 246],
    "Astreopora": [0, 52, 113],
    "Acropora_table": [0, 94, 32],
    "Turbinaria": [141, 198, 63],
    "CCA": [254, 207, 5],
    "Halimeda": [0, 255, 0],
    "Montipora_branching": [64, 102, 24],
    "Lobophora": [233, 5, 254],
    "Peysonnelia": [215, 40, 40],
    "Turf": [36, 124, 77],
    "Montipora_encrusting": [133, 170, 81],
    "Galaxaura": [157, 29, 31],
    "Other": [54, 54, 54],
    "Background": [0, 0, 0]}
